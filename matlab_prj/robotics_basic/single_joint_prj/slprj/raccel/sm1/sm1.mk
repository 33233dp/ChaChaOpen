...
MAKECMD         = /usr/local/MATLAB/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = sm1
MODULES                 = rtGetInf.c rt_nonfinite.c sm1.c sm1_capi.c sm1_data.c sm1_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = sm1
MAKEFILE                = sm1.mk
MATLAB_ROOT             = /usr/local/MATLAB
ALT_MATLAB_ROOT         = /usr/local/MATLAB
START_DIR               = /home/chacha/code/repo/ChaChaOpen/matlab_prj/robotics_basic/single_joint_prj
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 6
COMPUTER                = GLNXA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/usr/local/MATLAB" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,--allow-shlib-undefined -Wl,-rpath,/usr/local/MATLAB/sys/os/glnxa64
