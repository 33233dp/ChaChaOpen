...
#include "user_interfaces/msg/detail/user__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = user_interfaces::msg::User;
    is_plain =
      (
      offsetof(DataType, user_msg) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const user_interfaces::msg::User *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<user_interfaces::msg::User *>(
    untyped_ros_message);
...
{
  return &user_interfaces::msg::typesupport_fastrtps_cpp::_User__handle;
}
