...
class User(metaclass=Metaclass_User):
    ...
    def __init__(self, **kwargs):
        ...
        self.msg_content = kwargs.get('msg_content', str())
        from std_msgs.msg import String
        self.content = kwargs.get('content', String())
        from sensor_msgs.msg import Image
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.msg_content != other.msg_content:
            return False
    ...
    def msg_content(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'msg_content' field must be of type 'str'"
    ...
    def content(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'content' field must be a sub message of type 'String'"
        self._content = value
